...
function Show-SiteEditorDialog {
    ...
    $defaultIgnore = ".vscode, .git, .gitignore, .env*, *.pem, *.key, *.sql, *.sqlite, *.bak, node_modules, dist, build, *.log, *.map, vendor, _bk, __bk, _notes, deploy, .tmp*, .sass-cache, .superpowers, .expo, web.conf*, web.config, * - Copy*, *.7z, *.zip, *.bat, *.cmd, .aiexclude, .gitmodules"
